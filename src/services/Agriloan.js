    ...
    return (
        <div>
            ...
            <header>
                ...
                <div id="header-sticky" className="header-bottom__area header-bottom__transparent header-sticky-bg-2 header-bottom__bdr z-index-5">
                            ...
                            <div className="col-xxl-3 col-xl-3 col-lg-3 col-md-8 col-6">
                                <div className="header-bottom__right d-flex align-items-center justify-content-end">
                                    <div className="header-bottom__action header-bottom__action-4 d-none d-xl-block">
                                        <a className="d-none d-lg-inline-block header-bottom__action-2 border-none" href="register.html">
                                            <svg width={14} height={16} viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M7 8C8.92882 8 10.4924 6.433 10.4924 4.5C10.4924 2.567 8.92882 1 7 1C5.07118 1 3.50757 2.567 3.50757 4.5C3.50757 6.433 5.07118 8 7 8Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                                <path d="M13 15C13 12.291 10.3108 10.1 7 10.1C3.68917 10.1 1 12.291 1 15" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                                            </svg>
                                            <span>Log In</span>
                                        </a>
                                    </div>
                                    <div className="header-bottom__btn d-flex align-items-center">
                                        ...
                                        <a className="header-bottom__bar tp-menu-bar d-lg-none" href="#"><i className="fal fa-bars" /></a>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div id="smooth-wrapper">
                <div id="smooth-content">
                    ...
                    <footer>
                        ...
                        <div className="tp-footer__pl-pr pt-105">
                                ...
                                <div className="container">
                                    <div className="row">
                                        <div className="col-xl-3 col-lg-3 col-md-6 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".3s">
                                            <div className="tp-footer__widget footer-widget-3 tp-footer__input-inner footer-col-3-1">
                                        ...
                                        <div className="col-xl-2 col-lg-2 col-md-6 pb-30 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-6 pb-30 wow tpfadeUp z-index-3" data-wow-duration=".9s" data-wow-delay=".9s">
                                            <div className="tp-footer__widget tp-footer__input-inner footer-col-3-4">
                                                    ...
                                                    <form action="#">
                                                        ...
                                                        <span>
                                                            <svg width={18} height={16} viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M13 14.6H5C2.6 14.6 1 13.4 1 10.6V5C1 2.2 2.6 1 5 1H13C15.4 1 17 2.2 17 5V10.6C17 13.4 15.4 14.6 13 14.6Z" stroke="#5F6168" strokeWidth="1.5" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                                                                <path opacity="0.4" d="M13 5.39993L10.496 7.39993C9.672 8.05593 8.32 8.05593 7.496 7.39993L5 5.39993" stroke="#5F6168" strokeWidth="1.5" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                                                            </svg>
                                                        </span>
                                                        <button>
