            ...
            <div className="row">
              ...
              >
                <div className="tp-footer__widget footer-widget-2 footer-col-2-1">
                  <div
                    className="tp-footer__logo mb-25"
                  ...
                  <div className="tp-footer__contact-info">
                    ...
                    <ul>
                      <li>
                        ...
                        <a className="first-child" href="7658934523">
                          +91 7658934523
                        </a>
                      </li>
                      <li>
              ...
              >
                <div className="tp-footer__widget footer-widget-2 footer-col-2-2">
                  <h4 className="tp-footer__widget-title">Services</h4>
                  <div className="tp-footer__content">
                    <ul>
                      ...
                      <li>
                        <a href="/legalities">Legal compliance</a>
                      </li>
                      <li>
