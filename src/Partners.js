                                    ...
                                    <div className="col-xl-10">
                                        <div className="breadcrumb__content z-index-3 text-center">
                                            ...
                                            <div className="breadcrumb__text wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".6s">
                                                <p style={{color:'black'}}>We have collaborations with multiple banks.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="row grid">

                                    {
                                        bankdata.map((bank, index) => {
                                            return (
                                                <div key={index} className="col-xl-4 col-lg-6 col-md-6 col-sm-6 grid-item  cat1 cat4 cat3 cat5">
                                                    <div className="inner-project-item mb-30">
                                                        <div className="inner-project-img fix p-relative" style={{height:'200px',textAlign:'center'}}>
                                    ...
                                    <div className="col-12">
                                        <div className="tp-cta-bg" style={{background:`url(${ctabg})`}}>
                                            <div className="tp-cta-content tp-inner-font text-center">
                                                ...
                                                <a className="tp-btn-inner white-bg text-black" href="/services">Get Started Now</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
