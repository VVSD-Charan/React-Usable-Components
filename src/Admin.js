...
const Admin = () => {
    ...
    async function deleteJob(jobId) {
        try
        {
            const response = await axios.delete(`http://localhost:3001/deletejob/${jobId}`)
                                    ...
                                    <div className="row align-items-center">
                                        ...
                                        <div className="col-lg-3 col-md-3">
                                            <div className="job-post-apply-btn text-start text-md-end">
                                                <form onSubmit={()=>{deleteJob(item.jobId)}}>
                                                    <button type='submit' className="tp-btn-inner tp-btn-hover alt-color-orange"><span>Delete</span> <b /></button>
                                                </form>
                                            </div>
                                        </div>
                                    </div>
