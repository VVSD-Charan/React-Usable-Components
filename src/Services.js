                            ...
                            <div className="container">
                                <div className="row">
                                    <div className="col-12">
                                        <div className="about-img about-img-height p-relative" data-background="assets/img/breadcrumb/breadcrumb-2.jpg">
                            ...
                            <div className="tp-footer__area p-relative tp-footer__tp-border-bottom">
                                ...
                                <div className="container">
                                    <div className="row">
                                        ...
                                        <div className="col-xl-4 col-lg-4 col-md-6 pb-30 z-index-3 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".9s">
