                                    ...
                                    <div className="row">
                                        <div className="col-12">
                                            <div className="ab-brand-section-box text-center mb-50">
                                                <h4 className="ab-brand-title">Trusted by Hundreds of Banks</h4>
                                ...
                                <div className="row ab-company-section-space">
                                    <div className="col-xl-6">
                                        <div className="ab-company-section-box">
                                            ...
                                            <h3 className="tp-section-title">Busicon is Made <br />
                                                <p className="tp-section-title" style={{ fontSize: '30px', letterSpacing: '1px', lineHeight: '1.3' }}>For Secure, Streamlined Lending Solutions.</p></h3>
                                        </div>
                                    </div>
                                    <div className="col-xl-6 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".5s">
                                        <div className="ab-company-right">
                                            <div className="ab-company-section-text">
                                                <p className="pb-10">Busicon is a financial technology focused on problem-solving solutions in lending by a financial institution to a customer in India. Our stream-lined services maximize lending to every individual and avoid business loan rejections, scams, and frauds in banking services in India.</p>
                                                <p className="pb-10">We offer a one-stop solution that eliminates rejections and ensures better lending services for newly established businesses.</p>
                                                <p className="pb-10">We ensure protection against third-party broker fraud for all customers while providing increased access to government schemes and benefits throughout the entire process.</p>
                                    ...
                                    <div className="col-xl-6 col-lg-6 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".6s">
                                        <div className="tp-about__right">
                                            <div className="tp-about__section-box">
                                                <h4 className="tp-section-subtitle">OVER 15K+ CLIENT</h4>
                                                <h3 className="tp-section-title mb-15" style={{ fontSize: '30px' }}>Busicon: Empowering Financial Access
                                                </h3>
                                                <p>Unlocking Potential. Empowering Futures.</p>
                                            </div>
                                            <div className="tp-about__list">
                                                <ul>
                                                    <li><i className="fal fa-check" />Rural Banking Enhancement</li>
                                                    <li><i className="fal fa-check" />Navigating Rapid Lender Growth</li>
                                                    <li><i className="fal fa-check" />Enhancing the Financial Ecosystem</li>
                                                </ul>
                                            </div>
                                            <div className="tp-about__btn">
                                                <a className="tp-btn tp-btn-inner tp-btn-hover alt-color-black" href="/about">
                                                    <span>About Us</span>
                                                    <b />
                                                </a>
                                            </div>
